...
def test_convergence(
    a: float, b: float, fa: float, fb: float, settings: Dict[str, Any]
...
def init_state(f: Callable[[float], float], a: float, b: float) -> Dict[str, Any]:
    """
...
def brent_step(f: Callable[[float], float], state: Dict[str, Any], delta: float) -> Dict[str, Any]:
    """
...
def brent(f: Callable[[float], float], a: float, b: float, settings: Dict[str, Any]) -> float:
    """
